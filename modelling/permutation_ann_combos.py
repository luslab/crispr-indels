# PROTOSPACER PRECISION ANN - COMBINATION NTS (CORE) PERMUTATION
...
combos = [[18],[17],[16],[15],[18,17],[18,16],[18,15],[17,16],[17,15],[16,15],[18,17,16],[18,17,15],[18,16,15],[17,16,15],[18,17,16,15]]

for i in range(15):

    nt = '{0}{1}'.format('nt',i+1)
    filename = os.path.join('data','permutation','ann','{0}{1}{2}'.format('ANN_permutation_combo_',i+1,'_.csv')) # output file and dir
    with open(filename, "w") as csv_file:
        ...
        for j in range(10):
            ...
            for x in combos[i]:
                np.random.shuffle(df_test_x.iloc[:,x])
            ...
            print('combo',i+1,' bootstrap #',j,' completed.')
            if i+1 == 24:
